...
while(1):          
    ...
    match predicted_class:
        ...
        case 3:
            predicted_gesture = "Inactive"
            perform_no_gesture()

    # print(f"{datetime.now().strftime('%H:%M:%S.%f')}: Predicted gesture: {predicted_gesture}") # Prints predicted gesture with timestamp

    # For test, have a live timer set for individual gestures to compare predicted with actual results

    # Output robot joint variables based on predicted gesture
